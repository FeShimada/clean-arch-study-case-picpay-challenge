...
import br.com.project.core.domain.enums.TransactionStatusEnum;
...
public class Transaction {
    ...
    public Transaction(Long id, LocalDateTime updatedAt, LocalDateTime createdAt, TransactionStatusEnum status, BigDecimal value, Wallet fromWallet, Wallet toWallet) {
        this.id = id;
